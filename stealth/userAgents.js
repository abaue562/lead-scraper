...
/**
 * Curated list of real browser user-agent strings.
 * Mix of Chrome, Firefox, Edge, and Safari across Windows/Mac/Linux.
 * Updated 2025 — rotate per-request to avoid fingerprinting.
 */
module.exports = [
  // Chrome Windows
